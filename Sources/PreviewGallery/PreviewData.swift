...
///
/// `PreviewData` is used to store and manipulate a set of `PreviewType` instances,
/// providing functionality to filter and sort previews by module.
public struct PreviewData {
    ...
    /// It must be accessed from the main actor due to its use of `@MainActor`.
    ///
    /// - Note: This property is marked with `@MainActor`, ensuring it's only accessed from the main thread.
